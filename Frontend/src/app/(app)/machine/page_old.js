...
function EquiposPage() {
    ...
    const loadInitialData = async () => {
        ...
        try {
            ...
            // Cargar equipos en vista de jerarquía por defecto
    ...
    const applyFilters = async () => {
        ...
        try {
            if (searchTerm.trim()) {
                // Si hay término de búsqueda, usar search
                ...
                // Sin búsqueda, cargar según vista y filtro
                if (viewMode === 'hierarchy') {
                    await getMachineHierarchy({ setMaquinas: setEquipments })
                } else {
                    await getMachine({ 
    ...
    const handleAddChild = (parentEquipment) => {
        // Navegar a página de creación con padre preseleccionado
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-4">
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-4 lg:space-y-0">
                            ...
                            <div className="flex items-center space-x-4">
                                ...
                                {/* Controles de expansión (solo en vista jerarquía) */}
