...
function FormularioDinamico() {
    ...
    const [equipmentType, setEquipmentType] = useState('equipment') // equipment, sub_equipment, component, part
                                        ...
                                        <div className="mb-4">
                                            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                                                ...
                                                <ul className="text-sm text-blue-800 space-y-1">
                                                    ...
                                                    <li>• <strong>Sub-componentes:</strong> Elementos dentro de cada componente</li>
                                                    <li>• <strong>Partes:</strong> Piezas específicas de cada sub-componente</li>
                                                </ul>
