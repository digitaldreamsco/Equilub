...
function EquiposPage() {
    ...
    const confirmDelete = async (forceDelete = false) => {
        ...
        try {
            ...
            // Si requiere confirmación, mostrar modal especial
            if (result && result.requiresConfirmation) {
                setDeleteConfirmation(result)
    ...
    const handleViewDetails = (equipment) => {
        router.push(`/machine/${equipment.id}`)
    }
    ...
    return (
        <div className="py-5 px-5 bg-gray-100 min-h-screen">
            ...
            {/* Modal de confirmación especial para eliminación forzada */}
            {showForceDeleteModal && selectedEquipment && deleteConfirmation && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
                    <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
                        ...
                        <div className="mb-6">
                            ...
                            {deleteConfirmation.childrenCount && (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-3">
                                    <p className="text-sm text-yellow-800">
                                        <strong>Sub-equipos/Componentes:</strong> {deleteConfirmation.childrenCount}
                                    </p>
                                    <p className="text-xs text-yellow-700 mt-1">
                                        Todos los sub-equipos y componentes serán eliminados permanentemente.
                                    </p>
                                </div>
                            )}
                            {deleteConfirmation.studiesCount && (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-3">
                                    <p className="text-sm text-yellow-800">
                                        <strong>Estudios de lubricación:</strong> {deleteConfirmation.studiesCount}
                                    </p>
                                    <p className="text-xs text-yellow-700 mt-1">
                                        Todos los estudios de lubricación asociados serán eliminados permanentemente.
                                    </p>
                                </div>
                            )}
